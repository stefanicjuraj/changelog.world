...
Supported: C++, Deno, Django, Express, Figma, GitHub, GitLab, Go, Java, Laravel, Next.js, Node.js, PHP, Python, Rails, React, Scala, Slack, Spring Boot, Svelte, Swift, Tailwind, Vercel, Vue.js, WordPress.
...
Supported: `cpp`, `deno`, `django`, `express`, `figma`, `github`, `gitlab`, `go`, `java`, `laravel`, `netlify`, `nextjs`, `nodejs`, `php`, `python`, `rails`, `react`, `scala`, `slack`, `spring_boot`, `svelte`, `swift`, `tailwind`, `vercel`, `vuejs`, `wordpress`

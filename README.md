...
Supported: Laravel, C++, Java, Spring, Go, Next.js, GitLab, Python, PHP, Node.js, Django, Svelte, Express, Tailwind CSS, Swift, React, Vue.js, Vercel, GitHub.
...
Supported technologies: `laravel`, `cpp`, `java`, `spring`, `go`, `nextjs`, `gitlab`, `python`, `php`, `nodejs`, `django`, `svelte`, `express`, `tailwind`, `swift`, `react`, `vuejs`, `vercel`, `github`

...
function formatAsText(
  ...
  output += `Options:     cpp,deno,django,express,figma,github,gitlab,go,java,laravel,netlify,nextjs,nodejs,php,python,rails,react,react_native,scala,slack,spring_boot,svelte,swift,tailwind,vercel,vuejs,wordpress\n`;

...
function formatAsText(
  ...
  output += `Options:     cpp,deno,django,express,github,gitlab,go,java,laravel,nextjs,nodejs,php,python,rails,react,scala,slack,spring_boot,svelte,swift,tailwind,vercel,vuejs,wordpress\n`;
